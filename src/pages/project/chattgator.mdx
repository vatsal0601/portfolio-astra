---
title: "ChattGator"
excerpt: "ChattGator is an npm package that's easy to use and quick to set up. With just a few minutes, you can be up and running with your custom chat application"
